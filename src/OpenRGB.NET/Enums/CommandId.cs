...
public enum CommandId : uint
{
    ...
    /// <summary>Acknowledges a protocol-v6 packet.</summary>
    Ack = 10,
    ...
    /// <summary>Provides the protocol-v6 server name.</summary>
    SetServerName = 51,

    /// <summary>Declares protocol-v6 client capabilities.</summary>
    SetClientFlags = 52,

    /// <summary>Provides protocol-v6 server capabilities.</summary>
    SetServerFlags = 53,
    ...
    /// <summary>Indicates that server-side device detection started.</summary>
    DetectionStarted = 101,

    /// <summary>Reports server-side device detection progress.</summary>
    DetectionProgressChanged = 102,

    /// <summary>Indicates that server-side device detection completed.</summary>
